...
const SAMPLE_POSTS = [
  ...
  {
    content: 'CSS Centering div meme incoming... flexbox is pure magic 🪄✨',
...
async function seed() {
  ...
  console.log(`🎉 Successfully seeded ${postCount} posts (Photos, Memes, Reels) across ${createdUsers.length} creators!`);
}
