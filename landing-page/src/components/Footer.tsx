      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-5">
            <a href="https://www.linkedin.com/in/harsh-sharma-44476339b/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm font-semibold hover:text-primary transition-colors text-white/90">
              <Linkedin className="w-5 h-5" /> LinkedIn
            </a>
            <a href="https://github.com/HarshSharma20050924/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm font-semibold hover:text-primary transition-colors text-white/90">
              <Github className="w-5 h-5" /> GitHub
            </a>
            <a href="https://www.instagram.com/aqualyn2026?igsh=MThvOWd5bm9udHY1aA==" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm font-semibold hover:text-primary transition-colors text-white/90">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link to="/help" className="text-sm font-semibold text-white/90 hover:text-primary hover:underline transition-all font-bold text-primary">Help & Support</Link>
